      ...
      >
          ...
          {days.map((dayObj, index) => {
            ...
            return (
              <button
                ...
                className={`p-2 text-sm rounded-lg font-medium transition-all ${!dayObj.isCurrentMonth
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className={`flex-1 py-2.5 rounded-xl font-bold text-sm shadow-lg shadow-primary/20 transition-all ${selectedDay
