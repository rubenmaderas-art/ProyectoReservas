        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200/60 p-6 animate-fade-in">
            ...
            {loading ? (
                ...
                <div className="text-center py-20 bg-slate-50 rounded-xl border-2 border-dashed border-slate-200">
                    ...
                    <p className="text-slate-400 text-sm mt-1">Los usuarios aparecerán aquí una vez registrados.</p>
                </div>
            ) : (
                <div className="overflow-x-auto">
                    <table className="w-full text-sm text-left">
                        ...
                        <tbody>
                            {users.map((u) => (
                                <tr key={u.id} className="border-b border-slate-100 hover:bg-slate-50 transition-all duration-200">
                                    <td className="py-3 px-4 text-center text-slate-400 font-mono">{u.id}</td>
                                    <td className="py-3 px-4 text-center font-medium text-slate-700">{u.username}</td>
