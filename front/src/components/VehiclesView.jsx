                        ...
                        <tbody>
                            {vehicles.map((v) => (
                                <tr key={v.id} className="border-b border-slate-100 dark:border-slate-700/50 hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-all duration-200">
                                    <td className="py-3 px-4 text-center text-slate-400 dark:text-slate-500 font-mono">{v.id}</td>
                                    ...
                                    <td className="py-3 px-4 text-center text-slate-600 dark:text-slate-400">{v.kilometers.toLocaleString('es-ES')} km</td>
